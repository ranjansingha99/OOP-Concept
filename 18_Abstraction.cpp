...
// Find difference between Encapsulaton VS Abstraction
...
/* You can see in the above program we are not allowed to access the variables a and b directly, however, one can call the function set() 
